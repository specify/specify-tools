...
[process_file(os.path.join(global_base_dir, 'xlsx_to_tsv/%s.tsv' % file), os.path.join(specify6_src_dir_location, '%s_%s.properties' % (file, language_prefix))) for file in file_base_names]
