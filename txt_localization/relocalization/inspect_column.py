...
print(
	'\n'.join(
		[
			line.split(column_separator)[column_index] for line in lines
			if len(line.split(column_separator)) >= column_index and line.split(column_separator)[column_index] != ''
		]
	))
